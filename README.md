...
- **API**: Checko (РФ), допускаются к работе только компании со статусом "Действует" и финансовым отчетом, в дальнейшем такая же процедура планиурется для всех международних компаний через API
